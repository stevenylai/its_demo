...
public class shift_expression extends expression {
	String oper;
	public shift_expression() {
		createChildren();
	}
	public shift_expression (String oper) {
		this(); this.oper=oper;
	}
	public String getName () {
		if (oper==null)
			return "Nonterminal: shift_expression";
		else
			return "Nonterminal: shift_expression "+oper;
	}
	...
	public void generateCode (SymbolTable t, CodeStore codes) throws UndefinedSymbolException,TypeException {
		...
		if (oper.equals("<<"))
			codes.addInstruction("shiftl");
		else
			codes.addInstruction("shiftr");
	}*/
}
