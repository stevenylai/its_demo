...
public class AnimatedCar implements SensorConstants {
	...
	map=new Map();
	//map.loadMap("/itransnet_base/tracking/map.xml");
	updatePos(map);
	updateOrient ();
	...
	*/
	...
	if(realCar.getTurnDirection() > 0 &&
	   curSensor.getAdjectSensorMap().containsKey(Integer.valueOf(realCar.getTurnDirection()))) {
