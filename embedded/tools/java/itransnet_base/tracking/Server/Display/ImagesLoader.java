...
public class ImagesLoader
{
  ...
  */
  { 
    ...
    if (loadCount == 0)
      System.out.println("Err 1: No image(s) loaded for " + prefix);
    else 
  ...
  */
  {
    ...
    if (loadCount == 0)
      System.out.println("Err 2: No images loaded for " + name);
    else 
      imagesMap.put(name, imsList);
  ...
  */
  {
    ...
    if (loadCount == 0)
      System.out.println("Err 3: No images loaded for " + name);
    else {
      imagesMap.put(name, imsList);
  ...
  */
  {
    ...
    if (imsList == null) {
      System.out.println("Err 4: No image(s) stored under " + name);  
      return null;
    }
  ...
  */
  {
    ArrayList imsList = (ArrayList) imagesMap.get(name);
    if (imsList == null) {
      System.out.println("Err 5: No image(s) stored under " + name + "use 1 instead");  
      return null;
  ...
  */
  {
    ArrayList imsList = (ArrayList) imagesMap.get(name);
    if (imsList == null) {
      System.out.println("Err 6: No image(s) stored under " + name);  
      return null;
    }
  ...
  */
  ...
  // return all the BufferedImages for the given name
  {
    ArrayList imsList = (ArrayList) imagesMap.get(name);
    if (imsList == null) {
      System.out.println("Err 7: No image(s) stored under " + name);  
      return null;
    }
  ...
  // how many images are stored under <name>?
  {
    ArrayList imsList = (ArrayList) imagesMap.get(name);
    if (imsList == null) {
      System.out.println("Err 8: No image(s) stored under " + name);  
      return 0;
    }
    return imsList.size();
  } // end of numImages()
