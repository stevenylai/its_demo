...
public class exclusive_or_expression extends expression {
	String oper;
	public exclusive_or_expression() {
		createChildren();
	}
	public exclusive_or_expression (String oper) {
		this(); this.oper=oper;
	}
	public String getName () {
		if (oper==null)
			return "Nonterminal: exclusive_or_expression";
		else
			return "Nonterminal: exclusive_or_expression "+oper;
	}
